<!-- ══════════════════════════════════════════════════════════════════
     NASIL KULLANILIR
     1. GitHub'da kendi kullanıcı adınla aynı isimde bir repo oluştur
        (ör: github.com/<kullanici-adi>/<kullanici-adi>) — PUBLIC olmalı.
     2. Bu README.md'yi o repoya push et.
     3. Social linkleri ve "Featured Projects" bölümünü kendine göre düzenle.
     4. Yılan animasyonu için: .github/workflows/snake.yml dosyası repoda
        duruyor. GitHub > Actions > "Generate Snake" > Run workflow çalıştır.
        (İlk çalıştırmadan önce yılan görünmez, normaldir.)
     ══════════════════════════════════════════════════════════════════ -->
...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=4FD6BE&center=true&vCenter=true&random=false&width=650&lines=Full-Stack+Developer;Go+%2F+TypeScript+Enthusiast;Open+Source+Contributor;Clean+Architecture+Advocate;Coffee+%E2%86%92+Code+%E2%86%92+Deploy+%F0%9F%9A%80" alt="typing" />
...
[![Languages](https://skillicons.dev/icons?i=go,ts,js,python,rust&theme=dark)](https://skillicons.dev)
...
[![Backend](https://skillicons.dev/icons?i=nodejs,express,graphql,postgres,redis,docker,kubernetes,nginx&theme=dark)](https://skillicons.dev)

**Tools & Platforms**

[![Tools](https://skillicons.dev/icons?i=git,githubactions,linux,bash,neovim,vscode,cloudflare,aws&theme=dark)](https://skillicons.dev)
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:4FD6BE,100:70A5FD&height=120&section=footer" width="100%" alt="footer" />

### ⭐ Repolarımı beğendiysen bir yıldız bırakmayı unutma!
